<template>
  <div>
    ...
    <div class="share_code">
      ...
      <img src="../../files/images/4-4.png" height="212" width="212" class="code_img">
    </div>

    <div class="share_cover" v-show="showHide" @click="showCover">
      <img src="../../files/images/5-2.png" class="share_img" alt="">
    </div>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.computedScore();
      this.getScoreTip();
      document.body.style.backgroundImage = 'url(./static/files/images/4-1.jpg)';
    },
    methods: {
      computedScore() {
...
<style lang="less" scoped>
  body {
    background-image: url(../../files/images/4-1.jpg);
    padding-top: 1.2rem;
  }
  ...
  .your_scores_container {
    width: 9.7rem;
    height: 9.1rem;
    background: url(../../files/images/4-2.png) no-repeat;
  ...
  .share_button {
    ...
    background: url(../../files/images/4-3.png) no-repeat 0.4rem 0;
  ...
  .share_cover {
    ...
    top: 0;
    left: 0;
    background: url(../../files/images/5-1.png) no-repeat;
    background-size: 100% 100%;
    opacity: 0.92;
  }
